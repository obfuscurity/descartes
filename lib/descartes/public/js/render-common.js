...
function enableNightMode() {
  ...
  $('.reset-search.icon-remove-circle').addClass('icon-white');
  $('.search-query.span2').addClass('night');
  $('button.tools.btn.nightmode i').removeClass('icon-eye-close').addClass('icon-eye-open');
  $('.collfieldset.collapse.inapse').addClass('night');
  $('.search input').addClass('night');
  $('.btn').addClass('btn-inverse');
  $('.btn i').addClass('icon-white night');
...
function disableNightMode() {
  ...
  $('.reset-search.icon-remove-circle').removeClass('icon-white');
  $('.search-query.span2').removeClass('night');
  $('button.tools.btn.nightmode i').addClass('icon-eye-close').removeClass('icon-white icon-eye-open');
  $('.fieldset.collapse.in').removeClass('night');
  $('.search input').removeClass('night');
  $('.btn').removeClass('btn-inverse');
  $('.btn i').removeClass('icon-white night');
